import { Boxes, Code, GitBranch, Star } from "lucide-react";
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="bg-gradient-to-br from-background to-muted transition-transform hover:scale-105">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Stardex uses advanced machine learning algorithms to automatically group similar
                repositories, making it easier to discover and organize your GitHub stars.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-background to-muted transition-transform hover:scale-105">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Find repositories quickly with our powerful search and filtering system that
                understands programming languages, topics, and repository characteristics.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-gradient-to-br from-background to-muted transition-transform hover:scale-105">
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Hi, I&apos;m Bjorn Melin, a Senior Data Scientist specializing in machine learning
                and cloud solutions architecture. Stardex was born from my passion for organizing
                and discovering interesting GitHub projects in a more intelligent way.
              </p>
              <p>
                Based in Salt Lake City, I bring expertise in AI/ML and cloud architecture to create
                tools that help researchers and developers be more productive. When I&apos;m not
                coding, you can find me freestyle skiing in Utah&apos;s mountains.
              </p>
            </div>
          </CardContent>
        </Card>
